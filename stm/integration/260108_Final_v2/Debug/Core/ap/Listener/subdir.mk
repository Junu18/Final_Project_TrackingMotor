...
../Core/ap/Listener/Listener_Tracking.c 

OBJS += \
./Core/ap/Listener/Listener.o \
./Core/ap/Listener/Listener_Tracking.o 

C_DEPS += \
./Core/ap/Listener/Listener.d \
./Core/ap/Listener/Listener_Tracking.d 
...
clean-Core-2f-ap-2f-Listener:
	-$(RM) ./Core/ap/Listener/Listener.cyclo ./Core/ap/Listener/Listener.d ./Core/ap/Listener/Listener.o ./Core/ap/Listener/Listener.su ./Core/ap/Listener/Listener_Tracking.cyclo ./Core/ap/Listener/Listener_Tracking.d ./Core/ap/Listener/Listener_Tracking.o ./Core/ap/Listener/Listener_Tracking.su
