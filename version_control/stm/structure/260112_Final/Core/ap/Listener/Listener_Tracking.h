...
#define BTN_DEBUG_TILT_PLUS_GPIO	GPIOB
#define BTN_DEBUG_TILT_PLUS_PIN		GPIO_PIN_6
#define BTN_DEBUG_TILT_MINUS_GPIO	GPIOC
#define BTN_DEBUG_TILT_MINUS_PIN	GPIO_PIN_7
