...
../Core/ap/Presenter/Presenter_Tracking.c 

OBJS += \
./Core/ap/Presenter/Presenter.o \
./Core/ap/Presenter/Presenter_Tracking.o 

C_DEPS += \
./Core/ap/Presenter/Presenter.d \
./Core/ap/Presenter/Presenter_Tracking.d 
...
clean-Core-2f-ap-2f-Presenter:
	-$(RM) ./Core/ap/Presenter/Presenter.cyclo ./Core/ap/Presenter/Presenter.d ./Core/ap/Presenter/Presenter.o ./Core/ap/Presenter/Presenter.su ./Core/ap/Presenter/Presenter_Tracking.cyclo ./Core/ap/Presenter/Presenter_Tracking.d ./Core/ap/Presenter/Presenter_Tracking.o ./Core/ap/Presenter/Presenter_Tracking.su
